...
function basic_pie(container) {
  ...
  var
    ...
    watermarkAlpha = document.getElementById("watermarkAlpha").value,
    tickColor = document.getElementById("tickColor").value,
    labelMargin = document.getElementById("labelMargin").value,
    labelBoxBorderColor = document.getElementById("labelBoxBorderColor").value,
    labelBoxWidth = parseInt(document.getElementById("labelBoxWidth").value),
    labelBoxHeight = parseInt(document.getElementById("labelBoxHeight").value),
    labelBoxMargin = parseInt(document.getElementById("labelBoxMargin").value),
    legendMargin = parseInt(document.getElementById("legendMargin").value),
    legendBgOpacity = document.getElementById("legendBgOpacity").value,
    ...
    trackDecimals = document.getElementById("trackDecimals").value,
    ...
    mouseMargin = parseInt(document.getElementById("mouseMargin").value),
