...
Flotr.defaultOptions = {
  ...
  mouse: {
	...
	mouseTextColor: '#ffffff', // => text color in Value Box
	mouseBGColor: '#000000', // => background color of Value Box
	boxAlpha: 0.7, 			// => alpha for Value Box
...
Graph.prototype = {
  ...
  drawTooltip: function(content, x, y, options) {
    var mt = this.getMouseTrack(),
        mOp = options.boxAlpha,
        mbg = options.mouseBGColor,
        mtc = options.mouseTextColor,
        style = 'opacity:'+mOp+';background-color:'+mbg+';color:'+mtc+';display:none;position:absolute;padding:2px 8px;-moz-border-radius:4px;border-radius:4px;white-space:nowrap;',
        p = options.position,
        m = options.margin,
        plotOffset = this.plotOffset;
    if(x !== null && y !== null){
...
Flotr.addType('pie', {
  options: {
    ...
    strokeColor: null,	// => color of the slice borders
...
var
  ...
  _ = Flotr._,
  flotr = Flotr,
  S_MOUSETRACK = 'opacity:0.7;background-color:#ff0000;color:#333333;position:absolute;padding:2px 8px;-moz-border-radius:4px;border-radius:4px;white-space:nowrap;';
...
Flotr.addPlugin('hit', {
  ...
  drawMouseTrack : function (n) {
    ...
    var
      ...
      x           = n.x,
      y           = n.y,
         mOp = n.mouse.boxAlpha,
         mbg = n.mouse.mouseBGColor,
         mtc = n.mouse.mouseTextColor,
  S_MOUSETRACK = 'opacity:'+mOp+';background-color:'+mbg+';color:'+mtc+';position:absolute;padding:2px 8px;-moz-border-radius:4px;border-radius:4px;white-space:nowrap;',
